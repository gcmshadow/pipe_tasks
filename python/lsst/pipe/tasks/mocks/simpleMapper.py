...
class SimpleMapper(lsst.daf.persistence.Mapper, metaclass=MapperMeta):
    ...
    def __init__(self, root, **kwargs):
        ...
        # NOTE: we share band/physical here because `CoaddsTestCase.testCoaddInputs`
        # expects "r" for both the input dataIds and the output CoaddInputRecords.
        # The original data had just `Filter("r")`, so this has always assumed
        # that physicalLabel==bandLabel.
